...
# Chapter 5.13 Stacks
# stacks are LIFO behavior

print("\nChapter 5.13 Stacks" + "-" * 20)
browsing_session = []
browsing_session.append("http://cnn.com")
browsing_session.append("http://wtamu.com")
...
# assign two variables using thsi swap trick
a, b = 1, 2
print("x", x)
print('y', y)
...
# Notee: When using dict(), the key does not use quotes, the value does.
mlb_teams = dict(
    Boston="Red Sox",
    Houston="Astros",
    Chicago="Cubs",
...
# use .get() to get a key value pair that may not be in the dictionary
